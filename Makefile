...
# NOTE: Instead of using Makefile exports, source the env-setup script:
#   source ./env-setup

# Include modular makefiles
include tools/mk/environment.mk
...
# Targets for venv-setup, env-check, and help are now in tools/mk/*.mk files
